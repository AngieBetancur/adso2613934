        ...
        <section>
            <?php
                ...
                class Runner {
                    ...
                    public function run() {
                        return '<img height="300" width="300" src="./img//mario1.gif" alt="">';
                    }

                    public function stop() {
                        return '<img height="300" width="300" src="./img/stop.gif" alt="">';
                    }

                    public function jump() {
                        return '<img height="300" width="300" src="./img/jump.gif" alt="">';
                    }
                }

                $runner = new Runner('Mario Bros', 35, 105);
            ?>
            <h2>Class Runner</h2>
            <ul>
