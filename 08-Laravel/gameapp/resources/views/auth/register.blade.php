...
<header>
    ...
    <img src="images/title-register.png" alt="">
...
<section class="scroll">
    <form action="{{route('register')}}" method="POST" enctype="multipart/form-data>
        ...
        <div class="form-group">
            ...
            <img class="border" src="images/shape-border.svg" alt="">
        ...
        <div class="form-group">
            ...
            <input type="text" name="email" placeholder="Alfonso" value="{{old('fullname')}}">
        </div>
        <div class="form-group">
            <label>
        ...
        <div class="form-group">
            ...
            <input type="email" name="email" placeholder="alfonso@gmail.com" value="{{old('email')}}">
        </div>
        <div class="form-group">
            <label>
                Phone Number:
            </label>
            <input type="text" name="phone" placeholder="3102457896" value="{{old('phone')}}">
        </div>
        <div class="form-group">
            <label>
                Birth Date:
            </label>
            <input type="text" name="birthdate" placeholder="20/02/2025" value="{{old('birthdate')}}" >
        </div>
        <div class="form-group">
            <label>
                Password:
