...
<header>
    ...
    <img src="{{asset('images/logo-add-user.png')}}" alt="User Logo">
...
<section class="scroll">
    <form action="{{url('users')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="date" name="birthdate" placeholder="20/02/2025" value="{{old('birthdate')}}">
        </div>
        <div class="form-group">
            <label>
                Password:
        ...
        <div class="form-group">
            <button type="submit">
                <img src="{{asset('images/content-btn-add-user.svg')}}" alt="Login">
            </button>
        </div>
    </form>
</section>
